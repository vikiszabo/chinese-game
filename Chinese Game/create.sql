create table hanzi (id integer generated by default as identity, name varchar(255), pinyin varchar(255), primary key (id))
create table word (id integer generated by default as identity, chinese_meaning varchar(255), english_meaning varchar(255), primary key (id))
